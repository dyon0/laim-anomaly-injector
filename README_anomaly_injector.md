...
Механизм синтетической инъекции аномалий в трейсы AI-агентов (формат AEF Tracing CSV) для калибровки порогов детекции аномалий в системе MAS-monitor, основанной на фреймворке LumiMAS.
...
На данных `strategy_builder_3_6_k_top5.csv` (1 трейс, 5 спанов):

| Тест | Результат |
|------|-----------|
| Hallucination | ✅ 5 из 5 выходов модифицированы |
| Bias | ✅ 5 из 5 выходов модифицированы |
| DPI-Misinformation | ✅ Payload найден в `aef_input` (позиция 8785) |
| DPI-Exhaustion | ✅ Токены: 2127 → 15843 (×7.4) |
| DPI-Backdoor | ✅ Скрытые команды вставлены в `aef_input` |
| IPI | ✅ 4 из 5 выходов модифицированы (tool/chain спаны) |
| MP | ✅ 4 из 5 выходов модифицированы |
| CSV/Parquet экспорт | ✅ Оба формата работают |
